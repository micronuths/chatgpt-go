...
import (
	...
	"chatgpt-go/pkg/lemur/jsonschema"
)

func TestAPI(t *testing.T) {
	apiToken := os.Getenv("lemur_TOKEN")
	if apiToken == "" {
		t.Skip("Skipping testing against production lemur API. Set lemur_TOKEN environment variable to enable it.")
	}
