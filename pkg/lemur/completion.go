...
// GPT3 Defines the models provided by lemur to use when generating
// completions from lemur.
...
// Codex Defines the models provided by lemur.
...
type CompletionRequest struct {
	...
	// refs: https://platform.lemur.com/docs/api-reference/completions/create#completions/create-logit_bias
